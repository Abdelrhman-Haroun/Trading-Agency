<%@ Page Title="مورد جديد" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="newSupplier.aspx.cs" Inherits="WebApplication2.newSupplier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
        <tr>
            <td colspan="3" style="font-weight: 700;font-size:x-large;text-align:center">مورد جديد<br />
            </td>
        </tr>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td>اللقب</td>
            <td>
                <asp:TextBox ID="txtSupplierTitle" runat="server"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
